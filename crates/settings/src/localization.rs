...
const DEFAULT_STRINGS: &[(&str, &str)] = &[
    ...
    ("dialog.find.option.whole_word", "Match whole word"),
    ...
    ("dialog.find.button.find_prev", "Find Previous"),
    ("dialog.find.button.count", "Count"),
    ("dialog.find.button.find_all_open", "Find All in Open Documents"),
    ("dialog.find.button.find_all_current", "Search in Selection"),
    ("dialog.find.button.close", "Close"),
    ("dialog.find.placeholder", "{0}"),
