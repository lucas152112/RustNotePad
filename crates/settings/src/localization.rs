...
const DEFAULT_STRINGS: &[(&str, &str)] = &[
    ...
    ("dialog.find.tab.find", "Find"),
    ("dialog.find.tab.replace", "Replace"),
    ("dialog.find.tab.find_in_files", "Find in Files"),
    ("dialog.find.tab.mark", "Mark"),
    ("dialog.find.find_what", "Find what:"),
    ("dialog.find.replace_with", "Replace with:"),
    ("dialog.find.find_hint", "Type text to search"),
    ("dialog.find.option.up", "Search up"),
    ("dialog.find.option.whole_word", "Match whole word only"),
    ("dialog.find.option.match_case", "Match case"),
    ("dialog.find.option.wrap", "Wrap around"),
    ("dialog.find.search_mode", "Search Mode"),
    ("dialog.find.mode.normal", "Normal"),
    ("dialog.find.mode.extended", "Extended (\\n, \\r, ...)"),
    ("dialog.find.mode.regex", "Regular expression"),
    ("dialog.find.regex_dot", "`.` matches newline"),
    ("dialog.find.button.find_next", "Find Next"),
    ("dialog.find.button.count", "Count"),
    ("dialog.find.button.find_all_open", "Find All in Open Documents"),
    ("dialog.find.button.find_all_current", "Find All in Current Document"),
    ("dialog.find.button.close", "Close"),
    ("dialog.find.placeholder", "{0} is not available in the preview build."),
    ...
    (
        ...
        "Find Results: {0} hits across {1} files.",
    ),
    ("panel.find_results.empty", "Run a search to see results here."),
    ("panel.find_results.file_heading", "{0} ({1} hits)"),
    ("panel.find_results.entry", "Line {0} (Col {1}): {2}"),
    ("panel.find_results.untitled", "Untitled"),
    ...
    ("status.mode_label", "Mode: {0}"),
    ("status.encoding_label", "Encoding: {0}"),
    ("status.eol_label", "EOL: {0}"),
    ("status.eol.win", "Win"),
    ("status.eol.unix", "Unix"),
    ("status.eol.mac", "Mac"),
